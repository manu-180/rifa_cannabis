  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: AppColors.prizeGreen.withValues(alpha: 0.35),
          width: 1.2,
        ),
        boxShadow: [
          BoxShadow(
          ...
          BoxShadow(
            color: AppColors.prizeGreen.withValues(alpha: 0.12),
            blurRadius: 24,
            spreadRadius: -4,
          ),
        ],
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              gradient: LinearGradient(
                colors: [
                  AppColors.prizeGreen.withValues(alpha: 0.9),
                  AppColors.prizeGreenDark.withValues(alpha: 0.8),
                  AppColors.prizeGreen.withValues(alpha: 0.5),
                ],
            ...
            children: [
              ...
              Text(
                ...
                style: TextStyle(
                  ...
                  letterSpacing: 2,
                  color: AppColors.prizeGreen.withValues(alpha: 0.95),
                ),
              ),
            ],
          ),
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              gradient: LinearGradient(
                ...
                colors: [
                  AppColors.prizeGreen.withValues(alpha: 0.08),
                  AppColors.prizeGreen.withValues(alpha: 0.04),
                ],
              ),
              border: Border.all(
                color: AppColors.prizeGreen.withValues(alpha: 0.35),
            ...
            child: Row(
              ...
              children: [
                ...
                FaIcon(
                  FontAwesomeIcons.cannabis,
                  color: AppColors.prizeGreen.withValues(alpha: 0.85),
                  size: 24,
                ),
              ],
            ),
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Icon(Icons.card_giftcard_rounded, color: AppColors.textSecondary.withValues(alpha: 0.8), size: 14),
